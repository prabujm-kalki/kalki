...
import { z } from "zod";
import { getEffectiveEmployeeRole, RolesWorkServiceError } from "@/domains/roles-work/service";
...
export async function GET(request: Request) {
  ...
  try {
    return NextResponse.json({ effectiveRole: await getEffectiveEmployeeRole(user, scope.data) });
  } catch (error) {
