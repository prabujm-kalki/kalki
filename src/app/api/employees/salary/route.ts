...
import { setEmployeeSalaryInfo, EmployeeServiceError } from "@/domains/employees/service";
...
export async function POST(request: Request) {
  ...
  try {
    const employee = await setEmployeeSalaryInfo(user, employeeId, await request.json());
